const CLASSES_T20 = {
    ...
    "Clérigo": { pvInicial: 16, pvNivel: 4, pmInicial: 5, pmNivel: 5, atrPm: ["SAB"], periciasFixas: ["Religião", "Vontade"], periciasEscolha: 2, periciasClasse: ["Religião", "Vontade", "Cura", "Diplomacia", "Intuição", "Percepção", "Fortitude", "Reflexos", "Misticismo", "Investigação", "Conhecimento", "Nobreza"], caminhos: [{ label: "Clérigo (base)", value: "" }, { label: "Usurpador", value: "usurpador" }] },
